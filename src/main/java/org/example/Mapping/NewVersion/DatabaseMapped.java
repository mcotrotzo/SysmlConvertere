...
public class DatabaseMapped extends MappedElement<Type> implements Database {
	...
	private List<TwinIntegerMappedUsage> durationInDays = new ArrayList<>();
	...
	@Override
	public TwinIntegerAttributeUsage getDurationInDays() {
		return durationInDays.stream().findFirst().orElseThrow(() -> new RuntimeException("No durationInDays found"));
	}

	@Override
	public void parse(MappingContext context) throws MappingException {
		durationInDays = context.mapSlot(this, "durationInDays", TwinIntegerMappedUsage.class);
	}
}
