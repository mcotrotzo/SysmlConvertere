...
public class QueryFlowUsageMapped
		extends FlowUsageMapped
		implements QueryFlowUsage {
	...
	public QueryFlowUsageMapped(
			org.omg.sysml.lang.sysml.FlowUsage sysmlElement
	) {
		super(sysmlElement);
	}
