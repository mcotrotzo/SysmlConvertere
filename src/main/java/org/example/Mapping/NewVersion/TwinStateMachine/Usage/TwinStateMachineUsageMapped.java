package org.example.Mapping.NewVersion.TwinStateMachine.Usage;
...
public class TwinStateMachineUsageMapped extends TwinActionBlockUsage<StateUsage> implements TwinStateMachineUsage {
