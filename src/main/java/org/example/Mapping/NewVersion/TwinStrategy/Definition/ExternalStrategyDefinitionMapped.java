...
public class ExternalStrategyDefinitionMapped extends TwinStrategyDefinitionMapped implements ExternalStrategyDefinition {
	public ExternalStrategyDefinitionMapped(Classifier sysmlElement) {
		super(sysmlElement);
	}
