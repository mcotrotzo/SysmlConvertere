...
public class CustomStrategyDefinitionMapped extends TwinStrategyDefinitionMapped implements CustomStrategyDefinition {
	public CustomStrategyDefinitionMapped(Classifier sysmlElement) {
		super(sysmlElement);
	}
}
