...
@MappedMetaclass
public abstract class TwinExpression<T extends Expression> extends MappedElementExpression<T> implements org.example.Mapping.Interfaces.TwinExpression.TwinExpression {
